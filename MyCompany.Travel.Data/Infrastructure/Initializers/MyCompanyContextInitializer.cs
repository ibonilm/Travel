...
namespace MyCompany.Travel.Data.Infrastructure.Initializers
{
        ...
        : DropCreateDatabaseIfModelChanges<MyCompanyContext>
    {
        ...
        private string _picturePath = "{0}.jpg";
        private string _fakepicturePath = "FakeImages\\{0}.jpg";
        private string _smallPicturePath = "{0} - small.jpg";
        private string _fakesmallPicturePath = "FakeImages\\{0} - small.jpg";
        ...
        private void CreateEmployeePictures(MyCompanyContext context)
        {
            ...
            foreach (var employee in context.Employees)
            {
                ...
                if (!File.Exists(path))
                    path = string.Format(_fakesmallPicturePath, employeeName);
                ...
                if (!File.Exists(path))
                    path = string.Format(_fakepicturePath, employeeName);
